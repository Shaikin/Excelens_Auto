...
public class KeysUtil extends KeyMethods{
	...
	protected static String doubleClick(WebDriver driver,String refID,String testcaseName,String workFlow,String Step,String locatorType, String objectType, String objectLocator,String input,WebElement element){
		String flag=Constants_FRMWRK.False;
		String generic_Step="Click on ";
		Step=workFlow+generic_Step+Step;
				...
				if(actual_actionData.equals(data.trim())){
					...
					try{							
						while (counter< 5){
							try{
								//rowSearch.click();
								commonMethods.actionsClick(driver, rowSearch);
								WaitUtil.pause(1);
