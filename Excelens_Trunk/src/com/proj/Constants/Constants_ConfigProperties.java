...
public class Constants_ConfigProperties extends TestSuiteBase{ 
	...
	final public static String corporateSiteName = CONFIG.getProperty("corporateSiteName");
	   ...
	   //#R for Regression,p for Partial Regression,S for sanity
		...
		//# ie, firefox,chrome
			...
			final public static String browserType_CL = CONFIG.getProperty("browserType_CORP");
		...
		//# User Credentials  
			...
			final public static String username_BusinessOwner = CONFIG.getProperty("userUserName1");
			final public static String password_BusinessOwner = CONFIG.getProperty("userpassword1");
