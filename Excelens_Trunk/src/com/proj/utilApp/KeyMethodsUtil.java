	...
	public static String enter_autosuggest_browse(WebDriver driver,String testcasename,String workFlow,String step,String input,WebElement element) throws Throwable{
		...
		try{
			...
			try{
				...
				boolean prvPageDispayed=ElementPresence.isElementDisplayed(driver,Constants_FRMWRK.FindElementByXPATH,ObjRepository.choice_prvpage,Constants_TimeOuts.generic_TimeOut);
				...
				//prvPage.click();
				commonMethods.actionsClick(driver, prvPage);
				WaitUtil.pause(Constants_TimeOuts.generic_TimeOut);
				}
				...
				//choice.click();
				commonMethods.actionsClick(driver, choice);
				try{
					...
					//select.click();	
					commonMethods.actionsClick(driver, select);
					WaitUtil.pause(500L);
					try{
						...
						//ok.click();
						commonMethods.actionsClick(driver, ok);
