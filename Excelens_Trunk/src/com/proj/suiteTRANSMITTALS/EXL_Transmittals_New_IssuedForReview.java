...
public class EXL_Transmittals_New_IssuedForReview extends TestSuiteBase{	
	...
	public static void TestEXL_Transmittals_New_IssuedForReview(Hashtable<String,String>data
			) throws Throwable{
