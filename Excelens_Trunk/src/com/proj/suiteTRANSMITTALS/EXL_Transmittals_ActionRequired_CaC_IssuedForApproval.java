...
public class EXL_Transmittals_ActionRequired_CaC_IssuedForApproval extends TestSuiteBase{
	...
	public static void TestEXL_Transmittals_ActionRequired_CaC_IssuedForApproval(Hashtable<String,String>data
			) throws Throwable{
