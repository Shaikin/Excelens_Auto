...
public class TestSuiteBase extends TestBase {
	...
	public static void befMethod() throws Throwable{
		try {
			...
			driver_TRANS=ApplicationMethods.launch0365Login(browserName, Constants_ConfigProperties.testSiteName, Constants_ConfigProperties.username_SuperUser, Constants_ConfigProperties.password_SuperUser, refID);
