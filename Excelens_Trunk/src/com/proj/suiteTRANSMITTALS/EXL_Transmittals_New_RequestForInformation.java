...
public class EXL_Transmittals_New_RequestForInformation extends TestSuiteBase{
	...
	static String workflow_actions="Level-2/3:-Validating Associated Actions ";
	...
	public static void TestEXL_Transmittals_New_RequestForInformation(Hashtable<String,String>data
			) throws Throwable{
