...
public class EXL_Transmittals_ActionRequired_New_IssuedForApproval extends TestSuiteBase{
	...
	public static void TestEXL_Transmittals_ActionRequired_New_IssuedForApproval(Hashtable<String,String>data
			) throws Throwable{
		...
		try{			
			...
			//************************************** LEVEL 2 *****************************************************************************
			driver_TRANS=Workflows.Level2_Validate_OR_Submit_OR_ApproveOrReject_OR_Forward_OR_ReplyAll_Transmittal(siteName,Constants_Workflow.page_actionRequired,driver_TRANS,refID,testcaseName, workflow_l2, condition, workflow_end, Constants_ConfigProperties.testSiteName, browserName, Constants_ConfigProperties.username_BusinessOwner, Constants_ConfigProperties.password_BusinessOwner, transmittalData, data,1);
			//************************************** LEVEL 3 *****************************************************************************
