...
public class EXL_Transmittals_ActionRequired_New_IssuedForReview extends TestSuiteBase{
	...
	public static void TestEXL_Transmittals_ActionRequired_New_IssuedForReview(Hashtable<String,String>data
			) throws Throwable{
