...
public class EXL_Transmittals_New_IssuedForInformation extends TestSuiteBase{
	...
	public static void TestEXL_Transmittals_New_IssuedForInformation(Hashtable<String,String>data
			) throws Throwable{
		...
		try{
			...
			/*KeyMethods.f_performAction(driver_TRANS, refID, testcaseName, workflow_l1, "Navigate to Transmittals", Constants_FRMWRK.FindElementByXPATH, "button", ".//*[@class='navigationTop__item navigationTop__item--link']/a[text()='Transmittals']", "");
			KeyMethods.f_performAction(driver_TRANS, refID, testcaseName, workflow_l1, "Navigate to Transmittals", Constants_FRMWRK.FindElementByXPATH, "button", ".//*[@id='newTransmittal']", "");
*/
			//************************************** LEVEL 1 *****************************************************************************
			...
			//************************************** LEVEL 2 *****************************************************************************		
			driver_TRANS=Workflows.Level2_Validate_OR_Submit_OR_ApproveOrReject_OR_Forward_OR_ReplyAll_Transmittal(siteName,Constants_Workflow.page_myInbox,driver_TRANS,refID,testcaseName, workflow_l2, condition, workflow_end, Constants_ConfigProperties.testSiteName, browserName, Constants_ConfigProperties.username_BusinessOwner, Constants_ConfigProperties.password_BusinessOwner, transmittalData, data,1);
